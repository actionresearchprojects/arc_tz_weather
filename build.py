...
<div id="main">
  <div id="sidebar">
    ...
    <div id="solar-dist-controls">
      <div class="ds-label">Bin Size</div>
      <div class="wind-unit-notch">
        <button id="sd-25" class="wind-unit-btn" onclick="setSolarDistBin(25)">25 W/m²</button><button id="sd-50" class="wind-unit-btn active" onclick="setSolarDistBin(50)">50 W/m²</button><button id="sd-100" class="wind-unit-btn" onclick="setSolarDistBin(100)">100 W/m²</button>
      </div>
    </div>
