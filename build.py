  ...
  <div id="sidebar">
    ...
    <div id="wr-slider-wrap">
      ...
      <div style="margin-top:6px">
        ...
        <input id="wr-thresh-slider" type="range" min="0" max="40" step="0.5" value="0" style="width:100%;margin:0 0 4px 0;display:block" oninput="onWrThreshSlider(this.value)">
...
function setWindUnit(unit) {
  ...
  if (state.windUnit === 'ms')      { if (wrSl) { wrSl.min=0; wrSl.max=11;  wrSl.step=0.1; } }
  else if (state.windUnit === 'kn') { if (wrSl) { wrSl.min=0; wrSl.max=22;  wrSl.step=0.5; } }
  else                               { if (wrSl) { wrSl.min=0; wrSl.max=40;  wrSl.step=0.5; } }
...
function _buildWindRose(raw) {
  ...
  if (state.wrThreshKph && total) {
    ...
    traces.push({type:'scatterpolar', mode:'lines',
      r:[...Array(16).fill(abovePct), abovePct], theta:[..._C16, _C16[0]],
